...
class OnboardTwoScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<OnboardTwoBloc>(
        create: (context) => OnboardTwoBloc(
            OnboardTwoState(onboardTwoModelObj: OnboardTwoModel()))
          ...
          child: Scaffold(
              ...
              body: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        CustomImageView(
                            svgPath: ImageConstant.imgFrame11625,
                        ...
                        Container(
                            ...
                            margin: getMargin(left: 12, top: 41, right: 59),
                            child: Text("msg_earn_extra_and_buy".tr,
                                maxLines: null,
